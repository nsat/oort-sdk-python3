...
class RetrieveFileRequest(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    save_path: Annotated[str, Field(strict=True)] = Field(description="The destination path to save the file. Must be an absolute path.")
    __properties: ClassVar[List[str]] = ["id", "save_path"]

    @field_validator('save_path')
    def save_path_validate_regular_expression(cls, value):
