...
class AdcsTarget(BaseModel):
    """
    A ground location for the satellite to point at
    """ # noqa: E501
    lat: Union[StrictFloat, StrictInt] = Field(description="latitide in degrees")
    lon: Union[StrictFloat, StrictInt] = Field(description="longitude in degrees")
