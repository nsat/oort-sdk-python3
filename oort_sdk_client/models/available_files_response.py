...
class AvailableFilesResponse(BaseModel):
    ...
    """ # noqa: E501
    files: List[FileInfo]
    overflow: Optional[StrictBool] = Field(default=None, description="true if there are more files available than could be returned in this call")
    __properties: ClassVar[List[str]] = ["files", "overflow"]
